...
function ajaxHeart(event) {
  ...
  _axios2.default.post(this.action).then(function (res) {
    ...
    var heartCountEl = (0, _bling.$)('.heart-count');
...
function typeAhead(search) {
  ...
  var importantKeys = [keys.UP, keys.DOWN, keys.ENTER];
...
var searchEl = (0, _bling.$)('.search');
var mapEl = (0, _bling.$)('#map');
var heartForms = (0, _bling.$$)('form.heart');

(0, _autocomplete2.default)((0, _bling.$)('#address'), (0, _bling.$)('#lat'), (0, _bling.$)('#lng'));

(0, _typeAhead2.default)(searchEl);
(0, _map2.default)(mapEl);
